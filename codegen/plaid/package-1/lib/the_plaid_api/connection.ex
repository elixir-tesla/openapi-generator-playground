...
defmodule ThePlaidAPI.Connection do
  @moduledoc """
  Handle Tesla connections for ThePlaidAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, ThePlaidAPI.Connection,
        base_url: "https://production.plaid.com",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :the_plaid_api,
        :base_url, "https://production.plaid.com"
  """
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:the_plaid_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - ThePlaidAPI 2020-09-14_1.345.1 - elixir"
        )
      )
