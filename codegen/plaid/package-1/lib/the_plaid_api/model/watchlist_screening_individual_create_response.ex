...
defmodule ThePlaidAPI.Model.WatchlistScreeningIndividualCreateResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: ThePlaidAPI.Model.WatchlistScreeningIndividualCreateResponse do
