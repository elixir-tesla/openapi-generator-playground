...
defmodule ThePlaidAPI.Model.RiskCheckBehaviorUserInteractionsLabel do
  @moduledoc """
...
defimpl Poison.Decoder, for: ThePlaidAPI.Model.RiskCheckBehaviorUserInteractionsLabel do
