...
defmodule ThePlaidAPI.Model.WatchlistScreeningEntityCreateResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: ThePlaidAPI.Model.WatchlistScreeningEntityCreateResponse do
