...
defmodule ThePlaidAPI.Model.WatchlistScreeningIndividualListResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: ThePlaidAPI.Model.WatchlistScreeningIndividualListResponse do
