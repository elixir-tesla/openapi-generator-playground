...
defmodule ThePlaidAPI.Model.WatchlistScreeningEntityListResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: ThePlaidAPI.Model.WatchlistScreeningEntityListResponse do
